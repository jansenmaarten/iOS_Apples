#
# Be sure to run `pod spec lint Apples.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of Apples
  #
  #                   * Markdown format.
  ...
  # s.source       = { :svn => 'http://EXAMPLE/Apples/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/Apples', :revision => '1.0.0' }
